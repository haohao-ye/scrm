<template>
	<view class="r_detail">
		<view class="mess">
			...
			<input class="mess_02" placeholder="客户id" v-model="clientId" />
			...
			<view class="mess_02">订单状态：待出库</view>
			<view class="but">
...
<script>
	export default {
		...
		methods: {
			...
			yes() {
				// let sumbmitParams=this.params;
				// this.submitParams.goodsId=this.goods.id;
				// this.submitParams.quantity=this.goods.quantity;
				// this.submitParams.state="待出库";
				// this.submitParams.totalAmount=this.goods.price*this.goods.quantity;
				let that = this;
				uni.request({
